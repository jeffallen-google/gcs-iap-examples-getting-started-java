...
// based on code from https://cloud.google.com/iap/docs/signed-headers-howto
...
public class VerifyIapRequestHeader {
    ...
    boolean verifyJwtForAppEngine(HttpServletRequest request, long projectNumber, String projectId)
            throws Exception {
